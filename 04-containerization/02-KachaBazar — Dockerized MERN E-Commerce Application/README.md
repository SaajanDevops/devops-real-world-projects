...
The project uses separate images for each application service.
...
Production Node.js container running the Express API.

### Store

Production Next.js standalone application.

### Admin

Production React/Vite build served using Nginx.
