...
| [02-KachaBazar — Dockerized MERN E-Commerce Application](04-containerization/02-KachaBazar)                                       | Dockerized a full-stack MERN e-commerce app with separate production containers for the store frontend, admin dashboard, and backend API. Multi-stage builds, a distroless Node.js backend, NGINX for the admin frontend, MongoDB Atlas, environment-based config                                                               | Docker, Docker Compose, Node.js, Express, Next.js, React, NGINX, MongoDB Atlas |
| [03-VProfile — Dockerized Java Multi-Tier Application](04-containerization/03-VProfile — Dockerized Java Multi-Tier Applicationn) | Containerized the VProfile multi-tier Java app (Tomcat, MySQL, NGINX, Memcached, RabbitMQ) into 5 services with a multi-stage app build, images pushed to Docker Hub                                                                                                                                                            | Docker, Docker Compose, Docker Hub, Maven, Tomcat, MySQL, NGINX                |
