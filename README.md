...
| [03-VProfile — Dockerized Java Multi-Tier Application](04-containerization/03-VProfile — Dockerized Java Multi-Tier Application) | Containerized the VProfile multi-tier Java app (Tomcat, MySQL, NGINX, Memcached, RabbitMQ) into 5 services with a multi-stage app build, images pushed to Docker Hub                                                                                                                                                            | Docker, Docker Compose, Docker Hub, Maven, Tomcat, MySQL, NGINX                |
