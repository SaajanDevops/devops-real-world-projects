...
| Project                                                                                                                                                | Description                                                                                                                                                                                                                                                                                                                                                                 | Stack                                                                          |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| [01-docker-compose-notes-app](04-containerization/01-docker-compose-notes-app)                                                                         | Multi-service Notes REST API — two independent Express/MongoDB services behind an NGINX reverse proxy, combined from separate Compose projects via `include`/`override`. Multi-stage Dockerfiles with distroless production images and resilient inter-service communication that degrades gracefully when a dependency is down                                             | Docker, Docker Compose, Node.js/Express, MongoDB, NGINX                        |
| [02-KachaBazar — Dockerized MERN E-Commerce Application](04-containerization/02-KachaBazar%20%E2%80%94%20Dockerized%20MERN%20E-Commerce%20Application) | Dockerized a full-stack MERN e-commerce application with separate production containers for the store frontend, admin dashboard, and backend API. Uses multi-stage Docker builds, a distroless Node.js backend image, NGINX for the admin frontend, MongoDB Atlas for database hosting, environment-based configuration, and Docker Compose for multi-service orchestration | Docker, Docker Compose, Node.js, Express, Next.js, React, NGINX, MongoDB Atlas |
